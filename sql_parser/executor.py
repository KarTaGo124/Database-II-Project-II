...
class Executor:
    ...
    def _create_index(self, plan: CreateIndexPlan):
        try:
            ...
            result = self.db.create_index(plan.table, plan.column, plan.index_type.upper(), language=plan.language, feature_type=plan.feature_type)
